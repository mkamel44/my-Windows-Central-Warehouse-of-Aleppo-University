...
namespace مستودع
{
	public partial class Form10 : Form
	{
		...
		public void getRecordsMaterials()
		{
			...
			String selectSQL = "SELECT * FROM materials where ((material_date) >= #" + dateTimePicker1.Value.ToString("MM/dd/yyyy") + "#) AND ((material_date) < #" + dateTimePicker2.Value.ToString("MM/dd/yyyy") + "#) order by material_id desc";
